...
//				flyersShader.setUniformMatrix4f( "cameraInverseMatrix", _cam->getModelViewMatrix().getInverse() );
				flyersShader.setUniformMatrix4f( "cameraInverseMatrix", ofMatrix4x4::getInverseOf(_cam->getModelViewMatrix()) );
	
				//ofMatrix4x4::getInverseOf(_cam->getGlobalTransformMatrix()).getPtr()
